<?php
	...
	if(isset($_POST["mark"]) && isset($_POST["role"]) && isset($_POST["da"])){
		$sqlname="SELECT item_name FROM `items` WHERE id_items=:role";
		$sqlUsers = "INSERT INTO `accounting`( `mark`, `id_items`,`item_name`, `id_students`, `date`) VALUES (:mark, :role,$sqlname, $id, :da)";
